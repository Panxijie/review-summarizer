...
CATEGORY_RULES = [
    ...
    ("财务与资产", r"财富|理财|投资|基金|股票|纳斯达克|纳指|定投|资产配置|财务自由|攒钱|花钱|搞钱|富人思维|消费观|现金流|负债|储蓄|止盈|止损|回撤|解套|上涨结束|山顶|技术分析|ETF|QDII|金融|财经|经济|汇率|货币|银行|房地产|房价"),
    ("职场与发展", r"职场|求职|就业|职业选择|职业规划|岗位|面试|HR|背调|大厂|校招|春招|offer|工作经验|投简历|LeetCode|力扣|机考|笔试"),
    ("日常与生活", r"生活经验|消费|购物|健康|减脂|营养|美食|食谱|烹饪|做菜|饮食|食材|鸡胸|黑巧|巧克力|健身|训练|运动|体态|康复|二郎腿|护肤|穿搭|香水|手机壳|数码配件|摄影|构图|秃|脱发|黑头|假货|验货|添柏岚|汽车|汽油|发动机|燃油|装修|家装|智能家居|家电|家具|茶叶|茶文化|茶生活|线香"),
...
def classify(title: str, tags: list[str], body: str) -> tuple[str, str]:
    ...
    if category == "日常与生活":
        if re.search(r"减脂|营养|蛋白质|饮食|美食|食谱|烹饪|做菜|食材|鸡胸|黑巧|巧克力", primary, re.I):
            return category, "饮食与健康"
        if re.search(r"健身|训练|运动|体态|康复|二郎腿", primary, re.I):
            return category, "运动与训练"
